...
uint8_t u8x8_byte_4wire_hw_spi(U8X8_UNUSED u8x8_t *u8x8, uint8_t msg, uint8_t arg_int,void *arg_ptr)
{
...
uint8_t u8x8_stm32_gpio_and_delay(U8X8_UNUSED u8x8_t *u8x8,U8X8_UNUSED uint8_t msg, uint8_t arg_int,U8X8_UNUSED void *arg_ptr)
{
    switch (msg)
    {
